...
Now we create a function to tidy each sheet in each chunk of data. Each
...
![](unpivot_253_md_files/figure-gfm/tile%20map-1.png)<!-- -->
...
![](unpivot_253_md_files/figure-gfm/line%20chart-1.png)<!-- -->
